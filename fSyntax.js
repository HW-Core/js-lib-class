...
hw2.define([
    ...
    var mod = (function (modifiers) {
        ...
        obj.class = (function () {
            ...
            var descriptor=createDescr();

            var cl = function (members) {
                if (members !== undefined)
                    cl.members(members);
                
                var res=$.Class(descriptor);
                
                descriptor=createDescr(); // recreate descriptors
    ...
    $.class=$.public.class; //public shortcut
